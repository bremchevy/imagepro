...
import { Sparkles, Download, History, Image as ImageIcon, Upload } from "lucide-react";
...
export default function ImageEnhancementPage() {
  ...
  const handleProcessImage = async () => {
    ...
    try {
      ...
      const apiResponse = await fetch('/api/image-enhancement', {
        method: 'POST',
        body: formData,
      });
      ...
      toast.success("Image enhanced successfully!", {
        description: "Your image has been enhanced with the selected settings.",
      });
    } catch (error) {
      console.error('Error enhancing image:', error);
      toast.error("Failed to enhance image", {
        description: error instanceof Error ? error.message : "An error occurred while enhancing your image.",
      });
    } finally {
        ...
        <div className="container min-h-[calc(100vh-8rem)] py-4 sm:py-8">
          ...
          <div className="text-center mb-4 sm:mb-6">
            ...
            <p className="text-xs sm:text-sm text-gray-600 max-w-2xl mx-auto leading-relaxed px-4">
              Improve your image quality with AI-powered enhancements for brightness, contrast, and sharpness.
            </p>
          </div>
                    ...
                    {isProcessing && (
                      <div className="absolute inset-0 bg-black/50 backdrop-blur-sm flex items-center justify-center rounded-lg">
                        <div className="text-center">
                          ...
                          <p className="text-white text-sm font-medium">Enhancing your image...</p>
            ...
            <Card className="p-3 h-full bg-white border-0 shadow-sm">
              <div className="space-y-3">
                <div className="flex items-center gap-2">
                  <div className="p-1.5 rounded-lg bg-gradient-to-r from-orange-500 to-red-500 text-white shadow-md">
                    <Sparkles className="h-6 w-6" />
                  </div>
                  <div>
                    <h3 className="text-sm font-semibold text-gray-900">Image Enhancement</h3>
                    <p className="text-[10px] text-gray-600 mt-0.5">
                      Improve image quality with AI-powered enhancements
                    </p>
                  </div>
                </div>
                ...
                <div className="space-y-2">
                  ...
                  <div className="flex items-center justify-between bg-gray-50 p-2 rounded-md hover:bg-gray-100 transition-colors">
                    ...
                    <div className="flex items-center gap-2">
                      ...
                      />
                      <span className="text-xs text-gray-500 w-8 text-right">{sharpness}%</span>
                    </div>
                  </div>
                </div>
                ...
                <div className="flex gap-2">
                  <Button 
                    className="flex-1 bg-gradient-to-r from-orange-500 to-red-500 hover:opacity-90 text-white shadow-md hover:shadow-lg transition-all duration-200 text-sm py-1.5"
